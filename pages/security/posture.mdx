...
Email [**security@rubberfit.app**](mailto:security@rubberfit.app) with your questionnaire. We answer questionnaires honestly, even when the honest answer is "not yet — here's the timeline." Most questions can be answered from this page plus [Data handling](/security/data-handling) plus the [SOC 2 roadmap](/security/soc2-roadmap).
