...
Email **security@rubberfit.app**. Most questionnaires can be answered from this page plus [Security posture](/security/posture) plus [Data handling](/security/data-handling).
