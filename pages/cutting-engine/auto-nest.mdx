...
- [Free-roam](/cutting-engine/free-roam) — when manual placement beats Auto
- [Performance](/cutting-engine/performance) — solve-time benchmarks
- [Cut history](/audit-history/cut-history) — the `layout_json` archive
