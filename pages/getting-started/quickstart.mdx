...
import { StepRail } from '../../components/figures'
...
<StepRail
  ...
  label="Five-step onboarding rail from sign-up to first cut shipped"
/>
...
<Cards num={2}>
  <Cards.Card title="Configure operator roles" href="/roles-rbac/the-six-roles">
    Six roles, enforced at the database. Map them to your team.
  </Cards.Card>
  <Cards.Card title="Set reorder rules" href="/inventory/reorder-rules">
    Per-material thresholds + preferred suppliers. Auto-draft POs when stock crosses the line.
  </Cards.Card>
  <Cards.Card title="Free-roam mode" href="/cutting-engine/free-roam">
    When the spec needs manual placement, switch modes without losing the audit trail.
  </Cards.Card>
  <Cards.Card title="Branded customer PDFs" href="/jobs/customer-pdfs">
    Customize the customer-facing receipt — logo, terms, support contact.
  </Cards.Card>
</Cards>
