...
import { PressFlow } from '../../components/figures'
...
<PressFlow label="Three stages: blank stock, nested layout under the press, committed cut" />
...
<SeeAlso
  links={[
    { title: "Cutting engine overview", href: "/cutting-engine/overview" },
    { title: "Inventory rolls", href: "/inventory/rolls" },
    { title: "Jobs lifecycle", href: "/jobs/lifecycle" },
  ]}
/>
