...
<SeeAlso
  links={[
    { title: "Customer PDFs", href: "/jobs/customer-pdfs", blurb: "what customers see" },
    { title: "Operator assignment", href: "/jobs/operator-assignment", blurb: "queues + notifications" },
    { title: "Cut history", href: "/audit-history/cut-history" },
  ]}
/>
