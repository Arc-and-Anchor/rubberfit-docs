...
<StateMachine
  layout="linear"
  states={[
    { name: "Receive", type: "past" },
    { name: "Active", type: "current" },
    { name: "Cut", type: "future" },
    { name: "Retire", type: "future" },
    { name: "Quarantine", type: "future" },
  ]}
  caption="A roll moves left to right under normal flow; quarantine is a side state any active roll can enter."
/>
...
<SeeAlso
  links={[
    { title: "Offcuts", href: "/inventory/offcuts", blurb: "first-class reusable inventory" },
    { title: "Reorder rules", href: "/inventory/reorder-rules", blurb: "auto-trigger POs before stock-out" },
    { title: "Purchase orders", href: "/inventory/purchase-orders", blurb: "how rolls enter" },
    { title: "Cut history", href: "/audit-history/cut-history", blurb: "the per-cut record" },
  ]}
/>
