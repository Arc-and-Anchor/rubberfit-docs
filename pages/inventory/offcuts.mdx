...
<Cascade
  ...
  children={[
    { label: "Offcut A · 24″", width: 70 },
    { label: "Offcut B · 31″", width: 80 },
    { label: "Offcut C · 40″", width: 96 },
    { label: "Offcut D · 48″", width: 110 },
  ]}
  captionNumber="Fig. 1"
...
- [Rolls](/inventory/rolls) — parent stock
- [Cut history](/audit-history/cut-history) — what produces offcuts
