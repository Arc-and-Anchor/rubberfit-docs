...
Drafts can be cancelled freely. Sent POs can be cancelled with a note (recorded in `audit_log`). Received POs cannot be cancelled — corrections require a new PO with negative quantities.
